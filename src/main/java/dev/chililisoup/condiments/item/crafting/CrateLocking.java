...
public class CrateLocking extends CustomRecipe {
    //? if < 1.21 {
    /*public CrateLocking(ResourceLocation id, CraftingBookCategory category) { super(id, category); }
    *///?} else
    public CrateLocking(CraftingBookCategory category) { super(category); }
